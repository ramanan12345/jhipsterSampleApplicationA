...
public class JhipsterSampleApplicationAApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationAApp.class);

    private final Environment env;

    public JhipsterSampleApplicationAApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleApplicationA.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleApplicationAApp.class);
